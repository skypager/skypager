...
var featureMethods = ['image', 'stylesheet', 'script', 'css', 'lazyInject'];
function image(url) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  function _load(tag) {
    return function (url) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var result = document[parent].appendChild(element);
        console.log(result);
      });
    };
  }
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return this.loadBabel(options).catch(function (error) {
              _this3.runtime.error("Error loading babel: ".concat(error.message));
            });
...
function whenReady(fn) {
  ...
  if (typeof fn === 'undefined') {
    return new Promise(function (resolve, reject) {
      whenReady.call(_this, function (err, Babel) {
  ...
  if (this.ready) {
    ...
    this.once('ready', function (Babel) {
      fn(null, Babel);
    });
  }
}
