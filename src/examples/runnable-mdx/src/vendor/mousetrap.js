...
;(function(r, v, f) {
  ...
  function A(a) {
    ...
    return p[a.which]
      ? p[a.which]
      : t[a.which] ? t[a.which] : String.fromCharCode(a.which).toLowerCase()
  }
  function F(a) {
    var b = []
  ...
  function x(a) {
    return a == 'shift' || a == 'ctrl' || a == 'alt' || a == 'meta'
  }
  function B(a, b) {
    var g,
      c,
    ...
    g === '+'
      ? (g = ['+'])
      : ((g = g.replace(/\+{2}/g, '+plus')), (g = g.split('+')))
    for (d = 0; d < g.length; ++d)
      (c = g[d]),
        C[c] && (c = C[c]),
        b && b != 'keypress' && D[c] && ((c = D[c]), f.push('shift')),
        x(c) && f.push(c)
    g = c
    d = b
    if (!d) {
      if (!n) {
        n = {}
        for (var q in p)
          (q > 95 && q < 112) || (p.hasOwnProperty(q) && (n[p[q]] = q))
      }
      d = n[g] ? 'keydown' : 'keypress'
    }
    d == 'keypress' && f.length && (d = 'keydown')
    return { key: c, modifiers: f, action: d }
  }
  function E(a, b) {
    return a === null || a === v ? !1 : a === b ? !0 : E(a.parentNode, b)
  }
  function c(a) {
    function b(a) {
      a = a || {}
    ...
    function g(a, b, u, e, c, g) {
      ...
      for (l = 0; l < h._callbacks[a].length; ++l)
        if (
          ...
          var d
          ;(d = f == 'keypress' && !u.metaKey && !u.ctrlKey) ||
            ((d = m.modifiers), (d = b.sort().join(',') === d.sort().join(',')))
          d &&
            ((d = e && m.seq == e && m.level == g),
            ((!e && m.combo == c) || d) && h._callbacks[a].splice(l, 1),
            k.push(m))
        }
      return k
    }
    ...
    function d(a) {
      ...
      var b = A(a)
      b && (a.type == 'keyup' && z === b ? (z = !1) : h.handleKey(b, F(a), a))
    }
    function p(a, c, u, e) {
      function l(c) {
        return function() {
    ...
    function q(a, b, c, e, d) {
      ...
      f.length > 1
        ? p(a, f, b, c)
        : ((c = B(a, c)),
          (h._callbacks[c.key] = h._callbacks[c.key] || []),
          g(c.key, c.modifiers, { type: c.action }, e, a, d),
          h._callbacks[c.key][e ? 'unshift' : 'push']({
            callback: b,
      ...
      for (k = 0; k < e.length; ++k)
        e[k].seq
          ? e[k].level == h &&
            ((l = !0),
            (c[e[k].seq] = 1),
            f(e[k].callback, d, e[k].combo, e[k].seq))
          : l || f(e[k].callback, d, e[k].combo)
      e = d.type == 'keypress' && t
      d.type != y || x(a) || e || b(c)
      t = l && d.type == 'keydown'
    }
  ...
  if (r) {
    var p = {
      ...
      n
    for (f = 1; f < 20; ++f) p[111 + f] = 'f' + f
    for (f = 0; f <= 9; ++f) p[f + 96] = f.toString()
    ...
    c.init()
    r.Mousetrap = c
    typeof module !== 'undefined' && module.exports && (module.exports = c)
