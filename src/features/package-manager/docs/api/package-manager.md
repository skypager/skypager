...
### PackageManager.startAsync([options]) ⇒ [<code>PromiseLike.&lt;PackageManager&gt;</code>](#PackageManager)
...
### PackageManager.start([options], cb) ⇒ [<code>PromiseLike.&lt;PackageManager&gt;</code>](#PackageManager)
...
### PackageManager.activationEventWasFired([options]) ⇒ [<code>PromiseLike.&lt;PackageManager&gt;</code>](#PackageManager)
...
### PackageManager.whenActivated([options]) ⇒ [<code>PromiseLike.&lt;PackageManager&gt;</code>](#PackageManager)
...
### PackageManager.findNodeModules([options]) ⇒ <code>PromiseLike.&lt;Array.&lt;PackageManifest&gt;&gt;</code>
...
### PackageManager.selectModifiedPackages([options]) ⇒ <code>PromiseLike.&lt;Array&gt;</code>
...
## pickAllRemotesBy(pickBy) ⇒ <code>Array.&lt;Object&gt;</c