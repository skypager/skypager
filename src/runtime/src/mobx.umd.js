     ...
     */
            ...
            var ComputedValue = (function() {
              ...
              ComputedValue.prototype.whyRun = function() {
                ...
                var observing = unique(this.isComputing ? this.newObserving : this.observing).map(
                  function(dep) {
                    return dep.name
                  }
                )
            ...
            function invariant(check, message, thing) {
              if (!check)
                throw new Error(
                  '[mobx] Invariant failed: ' + message + (thing ? " in '" + thing + "'" : '')
                )
            }
            /**
            ...
            function joinStrings(things, limit, separator) {
              ...
              return (
                ...
                (things.length > limit ? ' (... and ' + (things.length - limit) + 'more)' : '')
              )
            }
            ...
            function isPropertyConfigurable(object, prop) {
              ...
              return (
                !descriptor || (descriptor.configurable !== false && descriptor.writable !== false)
              )
            }
            ...
            var Reaction = (function() {
              ...
              Reaction.prototype.whyRun = function() {
                var observing = unique(this._isRunning ? this.newObserving : this.observing).map(
                  function(dep) {
                    return dep.name
                  }
                )
